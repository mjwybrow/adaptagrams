...
int main(void) {
    ...
    router->setRoutingParameter(segmentPenalty, 30);
    router->setRoutingParameter(anglePenalty, 0);
    router->setRoutingParameter(crossingPenalty, 120);
    router->setRoutingParameter(clusterCrossingPenalty, 4000);
    router->setRoutingParameter(fixedSharedPathPenalty, 0);
    router->setRoutingParameter(portDirectionPenalty, 0);
    router->setRoutingParameter(shapeBufferDistance, 7.5);
    router->setRoutingParameter(idealNudgingDistance, 4);
    router->setRoutingParameter(reverseDirectionPenalty, 0);
    ...
    router->setRoutingOption(improveHyperedgeRoutesMovingAddingAndDeletingJunctions, false);
    router->setRoutingOption(nudgeSharedPathsWithCommonEndPoint, false);
    Polygon polygon;
