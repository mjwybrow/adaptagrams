...
int main(void) {
    ...
    ShapeRef *shapeRef21424960 = new ShapeRef(router, poly21424960, 21424960);
    router->addShape(shapeRef21424960);
    ...
    ShapeRef *shapeRef435105790 = new ShapeRef(router, poly435105790, 435105790);
    router->addShape(shapeRef435105790);
    ...
    ShapeRef *shapeRef40787191 = new ShapeRef(router, poly40787191, 40787191);
    router->addShape(shapeRef40787191);
    ...
    ShapeRef *shapeRef76911264 = new ShapeRef(router, poly76911264, 76911264);
    router->addShape(shapeRef76911264);
    ...
    ShapeRef *shapeRef506213376 = new ShapeRef(router, poly506213376, 506213376);
    router->addShape(shapeRef506213376);
    ...
    ShapeRef *shapeRef134604636 = new ShapeRef(router, poly134604636, 134604636);
    router->addShape(shapeRef134604636);
    ...
    ShapeRef *shapeRef14353632 = new ShapeRef(router, poly14353632, 14353632);
    router->addShape(shapeRef14353632);
    ...
    bool overlap = router->existsOrthogonalTouxhingCorners();
    delete router;
    return (overlap) ? 1 : 0;
};
