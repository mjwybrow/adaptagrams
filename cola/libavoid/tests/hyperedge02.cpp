...
int main(void) {
    ...
    */
    ...
    new ShapeConnectionPin(shapeRef1, 102, 0.5, 1, 10, (ConnDirFlags) 2);
    ...
    new ShapeConnectionPin(shapeRef2, 102, 0, 0.5, 10, (ConnDirFlags) 4);
    ...
    new ShapeConnectionPin(shapeRef3, 102, 1, 0.5, 10, (ConnDirFlags) 8);
    ...
    new ShapeConnectionPin(shapeRef5, 102, 0.5, 1, 10, (ConnDirFlags) 2);
    ...
    new ShapeConnectionPin(shapeRef7, 102, 0.5, 1, 10, (ConnDirFlags) 2);
    ...
    new ShapeConnectionPin(shapeRef10, 102, 0.5, 1, 10, (ConnDirFlags) 2);
    ...
    router->outputInstanceToSVG("output/hyperedge02");
    delete router;
    return 0;
};
