...
int main(void)
{
    ...
    router->outputDiagram(IMAGE_OUTPUT_PATH "output/junction04-1");
    ...
    router->processTransaction();
    router->outputDiagram(IMAGE_OUTPUT_PATH "output/junction04-2");
    ...
    router->processTransaction();
    router->outputDiagram(IMAGE_OUTPUT_PATH "output/junction04-3");
    ...
    router->processTransaction();
    router->outputDiagram(IMAGE_OUTPUT_PATH "output/junction04-4");
    
    // The junction just has two connector now, so merge these into one.
    newObjs.first->removeJunctionAndMergeConnectors();
    router->processTransaction();
    router->outputDiagram(IMAGE_OUTPUT_PATH "output/junction04-5");
