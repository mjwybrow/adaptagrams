...
int main(void) {
    ...
    new ShapeConnectionPin(shapeRef342721632, 0, 
    ...
    new ShapeConnectionPin(shapeRef404900496, 0, 
    ...
    router->addJunction(junctionRef265539540);

    ConnRef *connRef985644192 = new ConnRef(router, 985644192);
    ConnEnd srcPt985644192(shapeRef404900496, 0);
    ...
    ConnEnd dstPt467016913(shapeRef807558175, 0);
    ...
    ConnEnd srcPt45740440(shapeRef342721632, 0);
