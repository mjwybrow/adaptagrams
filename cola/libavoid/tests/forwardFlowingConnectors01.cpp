...
int main(void) {
    ...
    router->setRoutingParameter(crossingPenalty, 1000);
    ...
    router->setRoutingParameter(shapeBufferDistance, 1);
    ...
    //router->outputDiagram(IMAGE_OUTPUT_PATH "output/forwardFlowingConnectors01");
    delete router;
    return (suceeds ? 0 : 1);
};
